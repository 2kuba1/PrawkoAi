...
namespace Persistence.Migrations
{
    ...
    [Migration("20260428123010_AddGinIndexOnQuestions")]
    partial class AddGinIndexOnQuestions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Question", b =>
                {
                    ...
                    b.HasIndex("ContentDe")
                        .HasDatabaseName("IX_Questions_ContentDe_Trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("ContentDe"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("ContentDe"), new[] { "gin_trgm_ops" });

                    b.HasIndex("ContentEn")
                        .HasDatabaseName("IX_Questions_ContentEn_Trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("ContentEn"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("ContentEn"), new[] { "gin_trgm_ops" });

                    b.HasIndex("ContentPl")
                        .HasDatabaseName("IX_Questions_ContentPl_Trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("ContentPl"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("ContentPl"), new[] { "gin_trgm_ops" });

                    b.HasIndex("ContentUa")
                        .HasDatabaseName("IX_Questions_ContentUa_Trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("ContentUa"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("ContentUa"), new[] { "gin_trgm_ops" });
